...
afficher_barre_progression() {
    (
        ...
        echo "60"; sleep 0.5
        unzip -o "$FICHIER_ZIP" -d "$DOSSIER_DESTINATION"
        echo "80"; sleep 0.5
        rm "$FICHIER_ZIP"
        echo "90"; sleep 0.5
...
EOF
    ...
    dialog --title "Installation de Celeste64" --gauge "Téléchargement et installation en cours..." 10 60 0 2>&1 >/dev/tty
}
